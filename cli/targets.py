...
def _CompileCommand_from_intercepted_command(
    ...
    print("Converting intercepted command:")
    print(f"  original icmd: {icmd}")
    print(f"  updated arguments: {[update_arg(arg) for arg in raw_arguments]}")
    print(f"  original file: {filename}")
    print(f"  updated file: {update(filename)}")
